...
public class AppViewManager {
    ...
    public static final AppView ADDARTICLE_VIEW = view("AddArticle", AddArticlePresenter.class, MaterialDesignIcon.HOME, SHOW_IN_DRAWER, HOME_VIEW, SKIP_VIEW_STACK);
    public static final AppView ARTICLELIST_VIEW = view("ArticleList", ArticleListPresenter.class, MaterialDesignIcon.DASHBOARD, SHOW_IN_DRAWER);
